...
function Banner() {
    ...
    return (
        <div className=' h-svh w-full relative'>
            ...
            <div  className={`absolute w-[80%] -bottom-10   left-1/2 gap-3 -translate-x-1/2 rounded-md flex flex-col  ${lang === "ar" ? "md:flex-row-reverse" : "md:flex-row"}  items-center bg-[#EEEEEE] p-3`}>
